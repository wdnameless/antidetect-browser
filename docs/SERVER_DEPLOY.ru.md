...
| Панель просит пароль | Не должна — пароля у панели нет. Если видите запрос сохранённых данных, очистите `localStorage` для страницы: панель сама берёт API-ключ из `GET /ui/key` |
