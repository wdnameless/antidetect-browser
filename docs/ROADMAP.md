...
Текущая готовность: **MVP собран и расширен** — все фазы 0–5 + критические фичи (Tier 1) + Tier 2 (coherent-пресеты, Camoufox/Firefox-ядро) выполнены. Осталась опциональная полировка и полная валидация детекторов.
...
- ⏳ **TLS-фингерпринт (JA3/JA4)**: не спуфится (ограничение ядра; у Camoufox — стек Firefox, потенциально лучше).
