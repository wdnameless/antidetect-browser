...
fs.writeFileSync(
  ...
  [
    ...
    '',
    'HOW TO OPEN',
    '  1. Move this whole folder wherever you want it (a USB stick works — profiles travel with it).',
    `  2. Drag ${appName} to Applications, or run it straight from this folder.`,
    '  3. macOS will refuse the first launch because the app is ad-hoc signed, not notarized.',
