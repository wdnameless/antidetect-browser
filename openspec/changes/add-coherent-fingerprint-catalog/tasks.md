...
- [x] 1.5 Package catalog entries into compressed data bundle (`assets/fingerprints/catalog-v2.json`).
...
- [x] 2.4 Implement AudioContext and OS audio stack correlation checks.
...
- [x] 3.1 Update profile generation service to sample coherent archetypes instead of uncorrelated random values.
